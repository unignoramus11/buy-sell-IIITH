            ...
            >
              <DropdownMenu>
                ...
                >
                  <DropdownMenuItem
                    asChild
                    className={isSellerMode ? "text-white" : "text-black"}
                  >
                    <Link
                      href="/profile"
                  ...
                  />
                  <DropdownMenuItem className="text-red-600 dark:text-red-400 focus:text-red-600 dark:focus:text-red-400 focus:bg-red-600/10 dark:focus:bg-red-400/20">
